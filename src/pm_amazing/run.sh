# 发布最新版 直接运行   sh /root/trunk/src/pm_amazing/run.sh
# 仅更新web 加参数 web:  sh /root/trunk/src/pm_amazing/run.sh web
# 更新到svn对应版本 加参数 r:  sh /root/trunk/src/pm_amazing/run.sh full r 379
