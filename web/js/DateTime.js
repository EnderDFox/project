//日期控件
var DateTimeClass = /** @class */ (function () {
    function DateTimeClass() {
        //日期
        this.Date = new Date();
        //中文日期
        this.WeekMap = ['一', '二', '三', '四', '五', '六', '日'];
    }
    //初始化
    DateTimeClass.prototype.Init = function () {
        //创建数据
        this.CreateTable();
        //绑定事件
        this.BindActions();
    ...
    //显示控件
    DateTimeClass.prototype.Open = function (ele, str, func) {
        //回调
        this.CallFunc = func;
        //元素
        this.InputEle = ele;
    ...
    //设置位置
    DateTimeClass.prototype.SetPosition = function () {
        var plan = $('#dateTime');
    ...
    //创建数据
    DateTimeClass.prototype.CreateTable = function () {
        var html = '';
        //头
        html += '<div class="head"> \
    ...
    //填内容
    DateTimeClass.prototype.FillDate = function () {
        var now = new Date();
        var plan = $('#dateTime');
    ...
    //绑定事件
    DateTimeClass.prototype.BindActions = function () {
        var plan = $('#dateTime');
        //日期选择
    ...
    //修改日期
    DateTimeClass.prototype.UpdateDate = function (y, m, d) {
    ...
    //关闭
    DateTimeClass.prototype.HideDate = function () {
