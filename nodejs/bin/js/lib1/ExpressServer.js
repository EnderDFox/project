...
var ExpressServer = /** @class */ (function () {
    ...
    ExpressServer.prototype.init = function (argsOpts, initGetPostAllFunc) {
        var _this = this;
        if (argsOpts === void 0) { argsOpts = null; }
        if (initGetPostAllFunc === void 0) { initGetPostAllFunc = null; }
        if (!argsOpts) {
            argsOpts = {};
        }
        argsOpts['dir'] = 'd';
    ...
    ExpressServer.prototype.showFolderContent = function (req, res) {
        var reqUrl = req.url;
        if (reqUrl.indexOf('/') == 0) {
    ...
    ExpressServer.prototype.getChildFiles = function (dir, ignoreFunc) {
        var fileList = [];
    ...
    ExpressServer.EXT_MAP = ".map";
    ExpressServer.FAVICON_ICO = "/favicon.ico";
