...
$root.hellopbjs = (function() {
    ...
    hellopbjs.Login = (function() {
         ...
         * @implements ILogin
         * @constructor
         * @param {hellopbjs.ILogin=} [properties] Properties to set
         */
         ...
         * @static
         * @param {hellopbjs.ILogin=} [properties] Properties to set
         * @returns {hellopbjs.Login} Login instance
         */
         ...
         * @memberof hellopbjs.Login
         * @static
         * @param {hellopbjs.ILogin} message Login message or plain object to encode
        ...
        Login.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.hellopbjs.Login();
        ...
        Login.fromObject = function fromObject(object) {
            if (object instanceof $root.hellopbjs.Login)
                return object;
            var message = new $root.hellopbjs.Login();
         ...
         * @memberof hellopbjs.Login
         * @static
         * @param {hellopbjs.Login} message Login
    ...
    hellopbjs.createRole = (function() {
         ...
         * @constructor
         * @param {hellopbjs.IcreateRole=} [properties] Properties to set
         */
         ...
         * @static
         * @param {hellopbjs.IcreateRole=} [properties] Properties to set
         * @returns {hellopbjs.createRole} createRole instance
         */
         ...
         * @memberof hellopbjs.createRole
         * @static
         * @param {hellopbjs.IcreateRole} message createRole message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {hellopbjs.createRole} createRole
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        createRole.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.hellopbjs.createRole();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        createRole.fromObject = function fromObject(object) {
            if (object instanceof $root.hellopbjs.createRole)
                return object;
            var message = new $root.hellopbjs.createRole();
            if (object.name != null)
         ...
         * @memberof hellopbjs.createRole
         * @static
         * @param {hellopbjs.createRole} message createRole
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
